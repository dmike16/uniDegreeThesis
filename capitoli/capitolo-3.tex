...
Per completare la costruzione consideriamo una griglia spaziale $x_j=(j_1\Delta x,j_2\Delta x)$ con $j=(j_1,j_2)$ multi-indice in $\mathbb{Z}^2$ ed una griglia temporale $t^n=n\Delta t$ con $n\in\mathbb{N}$.
...
\] 
Nel nostro caso, in quanto l'equazione che approssimiamo è singolare quando il gradiente è $Du$ si annulla oppure quando $u_{x_1}^2+u_{x_3}^2=0$, è necessario introdurre una definizione di consistenza più generale.
\begin{definizione}
