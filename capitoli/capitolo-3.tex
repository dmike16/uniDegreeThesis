...
\[
F_*(Du(x,t),D^2u(x,t))\le\varepsilon\Delta u(x_j,t^n)\le F^*(Du(x,t),D^2u(x,t)),
\]
con $F_*$ e $F^*$ definite come in (\hyperref[eq:cp2-14]{\ref{eq:cp2-14}\ped{$cl$}}), risulta soddisfatta.  
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                 Section 3.3
%
