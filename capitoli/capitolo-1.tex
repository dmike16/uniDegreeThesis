...
\begin{figure}[!hp]
  ...
  \tdplotsetmaincoords{60}{40}
  \begin{tikzpicture}[tdplot_main_coords]
    [place/.style={shape=circle,draw=blue!50,fill=blue!20}]
    
    \coordinate (O) at (0,0,0);

       
    %\draw[thick,->,blue] (0,0,0)node[anchor=east]{$O$} -- 
    %(2,0,0) node[anchor=south]{$x$};
    %\draw[thick,->,blue] (0,0,0) -- (0,2,0) node[anchor=north]{$y$};
    %\draw[thick,->,blue] (0,0,0) -- (0,0,2.5) node[anchor=north east]{$z$};

    \tdplotsetcoord{P}{2.0}{90}{45};
    \tdplotsetcoord{P2}{5.5}{90}{45};
    \tdplotsetcoord{P3}{5.5}{90}{40};

    \draw [->,blue!52,thick](P) to[out=50,in=130](P2);
    ...
    \draw  [gray,tdplot_main_coords,dashed,thick] (O) ellipse (42pt and 20pt);
    \tdplotsetthetaplanecoords{40};
    \draw [gray,thick,tdplot_rotated_coords](1.5,0,0) arc (0:360:1.5);
