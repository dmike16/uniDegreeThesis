...
i dati iniziali dopo l'aggiunta del rumore ed in \emph{Fig} il denoising.

\begin{figure}[htb!]
  \centering
  \subfloat[][\emph{Sfera sporcata con rumore gaussiamo} al $t=0$.]
           {\includegraphics[width=.45\textwidth]{noise/imnoise/mcm/sphere/sphere100i-0-00}}\quad
  \subfloat[][\emph{Toro sporcato con rumore gaussiamo} al $t=0$.]
           {\includegraphics[width=.45\textwidth]{noise/imnoise/mcm/torus/torus100i-0-00}}\\
  \subfloat[][\emph{Manubrio sporcato con rumore gaussiamo} al $t=0$.]
           {\includegraphics[width=.45\textwidth]{noise/imnoise/mcm/dumbbell/dumb149i-0-00}}\quad
