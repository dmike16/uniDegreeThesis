...
\begin{columns}[T]
  \begin{column}{5cm}
    \centering
    \only<3>{\animategraphics[autoplay,loop,width=1.0\textwidth,height=0.55\textheight]{0.8}{noise/randNoise/mcm/torus/torus100r-}{0}{4}}
    \end{column}
  \begin{column}[T]{5cm}
    \centering
    \only<3>{\animategraphics[autoplay,loop,width=1.0\textwidth,height=0.55\textheight]{0.8}{noise/randNoise/vpmcm/torus/torus100r-}{0}{4}}
    \end{column}
  \end{columns}
\end{frame}
